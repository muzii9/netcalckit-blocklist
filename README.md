...
> **Status:** v0.2.0-alpha is published as a prerelease. The current `main` list contains 91 analytics, telemetry, advertising-measurement, and observability hostnames. The published v0.2.0-alpha release contains 13 rules.
