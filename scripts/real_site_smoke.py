...
CASES = [
    ("Chartbeat", "ping.chartbeat.net", 18,
     ["https://www.aljazeera.com/", "https://www.ctvnews.ca/", "https://thehill.com/"]),
    ("Simple Analytics", "queue.simpleanalyticscdn.com", 8,
     ["https://autoevents.simpleanalytics.com/", "https://www.simpleanalytics.com/"])
]
...
def main():
    ...
    if not browser_path:
        ...
        return 2
    report = {"utc": datetime.now(timezone.utc).isoformat(), "results": [],
